        ...
        <main className="min-h-screen bg-[#fffcf9]"> {/* Warmest White */}
            ...
            <div className="relative overflow-hidden pt-32 pb-16 lg:pt-48 lg:pb-24">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-6 py-2 bg-white/50 backdrop-blur-xl border border-secondary/30 rounded-full text-secondary-dark text-amber-700 font-black shadow-xl shadow-secondary/5">
                ...
                <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 bg-white rounded-[4rem] p-8 md:p-16 border border-secondary/20 shadow-[0_50px_100px_-20px_rgba(251,191,36,0.1)] relative overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                        <div className="space-y-4">
                            ...
                            <p className="text-lg text-gray-500 font-medium">Have a specific idea or partnership in mind? We'd love to hear from you. Expect a reply within 24 hours.</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4 group">
                                ...
                                <p className="font-bold text-gray-700">Available globally, serving locally.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10">
                        {status === 'success' ? (
                            ...
                            >
                                ...
                                <button className="w-full py-6 bg-primary text-white font-black rounded-[2rem] shadow-2xl shadow-primary/30 hover:shadow-primary/50 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4 group">
                                    <span className="text-xl">{t('submit_btn')}</span>
                                    <Send className="w-6 h-6 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform rtl:group-hover:-translate-x-2" />
                                </button>
                            </form>
                        )}
                    </div>
