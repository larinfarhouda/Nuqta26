            ...
            <div className="sticky top-24 z-40 bg-white/60 backdrop-blur-2xl border-b border-white/20 px-4 md:px-6 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <Link href="/" className="p-2 -ml-2 hover:bg-white/50 rounded-full transition-colors flex items-center gap-2 text-sm font-black text-gray-900 group">
                        ...
                        <span className="hidden sm:inline uppercase tracking-widest text-[10px]">Back to discovery</span>
                    </Link>
                    ...
                    <div className="hidden md:grid grid-cols-1 grid-rows-2 gap-4 col-span-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="relative h-full bg-gray-900/95 flex flex-col items-center justify-center text-white cursor-pointer group hover:bg-primary transition-colors">
                                ...
                                <span className="font-black text-xs uppercase tracking-widest">+12 Details</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-8 md:gap-16 mt-6 md:mt-10 relative z-10">
                ...
                <div className="md:col-span-8 space-y-8 md:space-y-10">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <div className="flex flex-wrap items-center gap-3">
                            <span className="px-4 py-1.5 bg-primary/10 backdrop-blur-md text-primary text-[10px] font-black uppercase tracking-widest rounded-full border border-primary/20 flex items-center gap-2">
                                ...
                                {event.category_name_en || 'Experience'}
                            </span>
                        ...
                        <div className="bg-white/40 backdrop-blur-xl border border-white/60 p-4 md:p-6 rounded-[2rem] shadow-xl shadow-primary/5 flex flex-col sm:flex-row sm:items-center gap-6 md:gap-12">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-0.5">When</span>
                                    <span className="text-sm font-black text-gray-900 capitalize">{new Date(event.date).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</span>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-lg shadow-gray-200/50 border border-gray-100">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-sm font-black text-gray-900 underline underline-offset-4 decoration-primary/30">
                                        {event.district && event.city ? `${event.district}, ${event.city}` : (event.location_name || 'Istanbul')}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative group overflow-hidden bg-gradient-to-br from-primary/5 via-white/40 to-secondary/5 backdrop-blur-xl p-6 md:p-8 rounded-[2.5rem] md:rounded-[3rem] border border-white/60 shadow-2xl shadow-primary/5 transition-all hover:shadow-primary/10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
                            <Link href={`/vendor/${event.vendor_id}`} className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left text-gray-900 group/vendor cursor-pointer">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-primary uppercase tracking-[0.2em] mb-1">Elite Organizer</p>
                                    <h3 className="text-xl md:text-2xl font-black text-gray-900 mb-2 group-hover/vendor:text-primary transition-colors">{event.vendors?.business_name || 'Nuqta Partner'}</h3>
                    ...
                    <div className="space-y-6 px-2">
                        <div className="flex items-center gap-4">
                            <h2 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">The Experience</h2>
                        ...
                        <div className="prose prose-sm md:prose-base text-gray-600 leading-[1.8] font-medium max-w-none whitespace-pre-line selection:bg-primary/20">
                            {event.description || 'This exclusive experience invites you to discover the hidden stories of Istanbul. Join us for a journey of connection and culture.'}
                        </div>
                    </div>
                    ...
                    {event.location_lat && (
                        <div className="space-y-6 pt-4">
                            <div className="flex items-center gap-4">
                                <h2 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Location Context</h2>
                                <div className="h-px flex-1 bg-gradient-to-r from-gray-200 to-transparent" />
                            </div>
                        ...
                        <div className="mt-6 p-6 md:p-8 bg-black/5 backdrop-blur-xl rounded-[2.5rem] space-y-5 border border-white/20 shadow-xl shadow-gray-200/50">
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        <p className="text-xs font-black text-gray-900 mb-0.5 uppercase tracking-wide">Elite Standards</p>
                                        <p className="text-[10px] text-gray-500 font-bold leading-relaxed">Hand-curated experiences vetted by our Istanbul team.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4 items-start">
                                    <div className="p-2 bg-white rounded-xl shadow-sm border border-gray-100">
                                    ...
                                    <div>
                                        <p className="text-xs font-black text-gray-900 mb-0.5 uppercase tracking-wide">Instant Support</p>
                                        <p className="text-[10px] text-gray-500 font-bold leading-relaxed">24/7 priority assistance for all community members.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
