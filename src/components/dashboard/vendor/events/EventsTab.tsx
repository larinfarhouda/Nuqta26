...
export default function EventsTab({ vendorData, demoMode = false }: { vendorData?: any; demoMode?: boolean }) {
    ...
    const [importedData, setImportedData] = useState<InstagramImportResult | undefined>(undefined);
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="text-white px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2 hover:shadow-lg transition-all hover:scale-105 active:scale-95"
                    ...
                    >
                        ...
                        {t('import_instagram') || 'استيراد'}
                    </button>
                    <button
                        onClick={() => { setEditingEvent(null); setImportedData(undefined); setIsFormOpen(true); }}
            ...
            {isFormOpen && (
                <EventForm
                    ...
                    onClose={() => { setIsFormOpen(false); setImportedData(undefined); }}
