...
export default function VendorHero() {
    ...
    return (
        <section className="relative overflow-hidden bg-gray-950 pt-24 md:pt-32 lg:pt-36 pb-20 md:pb-28">
            {/* Ambient glow effects */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-[-20%] right-[-10%] w-[700px] h-[700px] bg-[#2CA58D]/20 rounded-full blur-[150px]" />
                <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-[#2CA58D]/10 rounded-full blur-[120px]" />
                <div className="absolute top-[30%] left-[20%] w-[300px] h-[300px] bg-purple-500/5 rounded-full blur-[100px]" />
                {/* Dot grid */}
                <div
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
                    ...
                    <div className={`transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        {/* Trust chip */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/[0.06] border border-white/10 rounded-full text-xs font-bold text-white/70 mb-6 backdrop-blur-sm">
                            <div className="flex -space-x-1.5 rtl:space-x-reverse">
                                <div className="w-5 h-5 rounded-full bg-[#2CA58D] flex items-center justify-center ring-2 ring-gray-950">
                                    <CheckCircle2 className="w-3 h-3 text-white" />
                                </div>
                                <div className="w-5 h-5 rounded-full bg-emerald-400 ring-2 ring-gray-950" />
                                <div className="w-5 h-5 rounded-full bg-teal-300 ring-2 ring-gray-950" />
                            </div>
                            <span>300+ organizers already automated</span>
                        </div>

                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-6xl font-black text-white leading-[1.08] tracking-tight mb-6">
                            {t('title')}
                        </h1>

                        <p className="text-base md:text-lg text-white/50 font-medium leading-relaxed max-w-xl mb-8 md:mb-10">
                            {t('subtitle')}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-3 mb-10">
                            <Link
                                ...
                                className="inline-flex items-center gap-3 px-8 py-4 bg-[#2CA58D] text-white font-bold text-base rounded-xl transition-all duration-300 shadow-2xl shadow-[#2CA58D]/25 hover:shadow-[#2CA58D]/40 hover:bg-[#25917b] active:scale-[0.97] group"
                            >
                                {t('cta')}
                            ...
                            <Link
                                href="/demo/vendor"
                                className="inline-flex items-center gap-2 px-6 py-4 text-white/60 hover:text-white font-medium text-sm transition-colors border border-white/10 rounded-xl hover:border-white/20 hover:bg-white/5"
                            >
                                {t('demo_cta')}
                            </Link>
                        </div>
                            ...
                            {stats.map((stat, i) => {
                                ...
                                return (
                                    <div key={i} className="group">
                                        ...
                                        <span className="text-[10px] md:text-xs font-bold text-white/40 uppercase tracking-wider">
                                            {stat.label}
                                        </span>
                                    </div>
                                );
                    ...
                    <div className={`relative transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                        <div className="relative">
                            {/* Glow behind mockup */}
                            <div className="absolute inset-0 bg-[#2CA58D]/15 rounded-3xl blur-[60px] scale-90" />

                            {/* Main dashboard card */}
                            <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-white/10 p-5 md:p-6 shadow-2xl">
                                {/* Dashboard header */}
                            ...
                            <div className="absolute -top-3 -end-3 md:-end-6 bg-white rounded-xl shadow-2xl shadow-black/20 p-3 flex items-center gap-2.5 animate-float-slow z-20 border border-gray-100">
                            ...
                            <div className="absolute -bottom-2 -start-3 md:-start-6 bg-white rounded-xl shadow-2xl shadow-black/20 p-3 flex items-center gap-2.5 animate-float-delayed z-20 border border-gray-100">
